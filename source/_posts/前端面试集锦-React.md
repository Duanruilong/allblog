...
![js](https://raw.githubusercontent.com/Duanruilong/phone_drl/master/image/blog/webtry_d.jpg)
...
> [原文README.md](https://github.com/semlinker/reactjs-interview-questions/edit/master/README.md)
...
1. ### 什么是 React?
    ...
    3. [掘金 - 200行代码实现简版react](https://juejin.im/post/5c0c7304f265da613e22106c)
...
8. ### React 的状态是什么?
    ...
    ![state](https://raw.githubusercontent.com/Duanruilong/phone_drl/master/image/interview/state.jpg)
...
25. ### Virtual DOM 如何工作?
    ...
    *Virtual DOM* 分为三个简单的步骤。
    ...
    1. 每当任何底层数据发生更改时，整个 UI 都将以 Virtual DOM 的形式重新渲染。
        ![vdom](https://raw.githubusercontent.com/Duanruilong/phone_drl/master/image/interview/vdom1.png)

    2. 然后计算先前 Virtual DOM 对象和新的 Virtual DOM 对象之间的差异。
        ![vdom2](https://raw.githubusercontent.com/Duanruilong/phone_drl/master/image/interview/vdom2.png)

    3. 一旦计算完成，真实的 DOM 将只更新实际更改的内容。
        ![vdom3](https://raw.githubusercontent.com/Duanruilong/phone_drl/master/image/interview/vdom3.png)
...
33. ### 组件生命周期的不同阶段是什么?
    ...
    ![phases 16.3+](https://raw.githubusercontent.com/Duanruilong/phone_drl/master/image/interview/phases16.3.jpg)

    React 16.3 之前

    ![phases 16.2](https://raw.githubusercontent.com/Duanruilong/phone_drl/master/image/interview/phases.png)
...
6.   ### 如何在 React Router v4 中获取查询字符串参数?
...
8.   ### 如何在 React Router v4 中将 params 传递给 `history.push` 方法?
...
1.   ### 什么是 Flux?
     ...
     *Flux* 是*应用程序设计范例*，用于替代更传统的 MVC 模式。它不是一个框架或库，而是一种新的体系结构，它补充了 React 和单向数据流的概念。在使用 React 时，Facebook 会在内部使用此模式。
     ...
     ![flux](https://raw.githubusercontent.com/Duanruilong/phone_drl/master/image/interview/flux.png)
...
5.   ### `mapStateToProps()` 和 `mapDispatchToProps()` 之间有什么区别?
...
11.  ### 在 React 中如何使用 Redux 的 `connect()` ?
...
17.  ### 我应该在 Redux Store 中保留所有组件的状态吗?
...
21.  ### 编写 `mapDispatchToProps()` 有哪些不同的方法?
...
22.  ### 在 `mapStateToProps()` 和 `mapDispatchToProps()` 中使用 `ownProps` 参数有什么用?
...
26.  ### 在 redux-saga 中 `call()` 和 `put()` 之间有什么区别?
...
28.  ### `redux-saga` 和 `redux-thunk` 之间有什么区别?
...
237. ### 从错误边界跟踪组件堆栈有什么好处?
     ...
     ![stacktrace](https://raw.githubusercontent.com/Duanruilong/phone_drl/master/image/interview/error_boundary.png)
